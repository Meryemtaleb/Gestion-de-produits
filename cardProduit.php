...
<div class="m-2 animtop">
    ...
    <div class="text-center">
        ...
        <p class="">Catégorie : <span class="text-capitalize"><?php echo($produit['cat'])?></span></p>
        </p>
        ...
        <?php if (isset($_SESSION['PROFILE']) && $_SESSION['PROFILE']['role'] === 'responsable') { ?>
            <div class="d-flex justify-content-center">
                ...
                <a class="btn btn-info me-2"href="editProduit.php?id=<?php echo($produit['id']);?>">Modifier</a>
                <!-- 
                    Demande confirmation avant suppression avec la function confirm()
                    Envoie id du profil via $_GET vers => editProduit.php grace à ?id= 
                -->
                <a onclick="return confirm('Vous confirmez ?')"class="btn btn-warning"href="deleteProduit.php?id=<?php echo($produit['id'])?>">Supprimer</a>
            </div>
        <?php } ?>
    </div>
</div>
