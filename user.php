...
<body>
    ...
    <div class=" card container mt-3">
        <h2 class="text-center  text-primary fs-1 anim">La liste des utilisateurs</h2>
        <div class="card-body">
            <table class="table ">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <?php while ($user = $ps->fetch()) { ?>
                        <tr class="animleft">
                            ...
                            <td><img class="rounded-circle" src="images/<?php echo ($user['photo']) ?>" width="100" height="100" alt=""></td>
                            ...
                            <?php if ($_SESSION['PROFILE']['role'] === 'responsable') { ?>
                                <td>
                                    ...
                                    <a class="btn btn-info" href="editUser.php?pseudo=<?php echo ($user['pseudo']) ?>">Modifier </a>
                                </td>
                                <td>
                                    <!-- 
                                        ...
                                        -->
                                    <a class="btn btn-warning" onclick="return confirm('Êtes vous sûr ?');" href="deleteUser.php?pseudo=<?php echo ($user['pseudo']) ?>"> Supprimer </a>
                                </td>
                ...
                <div class="d-flex justify-content-center">
                    <?php if ($_SESSION['PROFILE']['role'] === 'responsable') { ?>
                        ...
                        <a class="btn btn-success animtop me-5" href="inscription.php">Ajouter un utilisateur</a>
