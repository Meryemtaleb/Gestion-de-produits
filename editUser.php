...
<body>
    ...
    <div class="container d-flex flex-column align-items-center mt-5">
        ...
        <form action="updateUser.php?pseudo=<?php echo ($user['pseudo']); ?>" method="post" class="col-8" enctype="multipart/form-data">
            ...
            <div class="mb-3 animtop">
               ...
               <img  src="images/<?php echo ($user['photo']); ?>" width="100" height="100" alt=""> 
            </div>
            <div class="mb-3 animtop">
